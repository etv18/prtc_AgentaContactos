    ...
    <div class="w-[70%] mx-auto sm:px-6 lg:px-8">
        <form class="max-w-md ml-0 w-full" action="{{ route('contactos.update', $contacto->id) }}" method="POST">
            ...
            <div class="py-12 w-full">
                ...
                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Guardar Edicion</button>
            </div>
        </form>
    </div>
    <script>
