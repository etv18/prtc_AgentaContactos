<x-contact-layout>
    <div class="w-[70%] mx-auto sm:px-6 lg:px-8">
        <form class="max-w-md ml-0 w-full">
            <div class="py-12 w-full">
                ...
                <div class="relative z-0 w-full mb-5 group mt-4">
                    <label for="etiqueta" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Etiquetas</label>
                    <select id="etiqueta" name="etiqueta" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option></option>
